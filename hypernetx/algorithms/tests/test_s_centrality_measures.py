...
def test_s_harmonic_closeness_centrality(sixbyfive):
    h = sixbyfive.hypergraph
    shcc = s_harmonic_closeness_centrality(h, s=1)
    s1 = {'e0': 1.0, 'e1': 1.0, 'e2': 1.0, 'e3': 1.0, 'e4': 1.0}
    for e in h.edges:
        assert shcc[e] == s1[e]
    shcc = s_harmonic_closeness_centrality(h, s=2)
    s2 = {'e0': 1.0, 'e1': 0.875, 'e2': 0.875, 'e3': 0.75, 'e4': 1.0}
    for e in h.edges:
        assert shcc[e] == s2[e]
    shcc = s_harmonic_closeness_centrality(h, s=3)
