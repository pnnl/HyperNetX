...
class Hypergraph():
    ...
    # @not_implemented_for('static'). Take this out and let system check for equality
    ...
    def s_degree(self, node, s=1, edges=None):  # deprecate the edges
        """XX
        Return the s-degree of a node in H when restricted to edges
