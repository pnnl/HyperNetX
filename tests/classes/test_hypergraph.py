...
def test_adjacency_matrix(sevenbysix):
    ...
    assert np.allclose(adjacency_matrix.toarray, sevenbysix.s1_adjacency_matrx.A)
...
def test_edge_adjacency_matrix(sevenbysix):
    ...
    assert np.allclose(adjacency_matrix.toarray, sevenbysix.s1_edge_adjacency_matrx.A)
...
def test_auxiliary_matrix_on_edges(sevenbysix):
    ...
    assert np.allclose(aux_matrix.toarray, sevenbysix.s1_edge_adjacency_matrx.A)
